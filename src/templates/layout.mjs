...
<a class="wa-flotante" href="https://wa.me/${site.telefonoHref.replace('+', '')}?text=${encodeURIComponent(o.waTexto || 'Hola, quiero información sobre las carreras de TAMABA')}" target="_blank" rel="noopener" aria-label="Escribinos por WhatsApp" data-tb="whatsapp-flotante">
